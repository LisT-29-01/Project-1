...
public class Aiv3
{
    ...
    private static final int DEPTH_PATH = 25;
    ...
    private static final int KN = 305;
    private static final int KE = 121;
    ...
    private int maxValue(final MapS map, final int x, final int y, final int xe, final int ye, final int depth, int alpha, final int beta) {
        ...
        if (this.crack || this.enemyInside(map, xe, ye, x, y)) {
            if (depth > 0) {
                ...
                max = 305 * this.luonggia(new MapS(map), x, y, xe, ye, true) + 121 * this.luonggiacanh(new MapS(map), x, y, xe, ye, true);
            }
            if (max == -80000) {
                max = -40000 - depth;
            }
        ...
        final int t = 305 * this.luonggiaOutside(new MapS(map), x, y, xe, ye) + 121 * this.luonggiacanh(new MapS(map), x, y, xe, ye, true);
        if (t > 1 || t < -1) {
            return t * 5;
        }
        return t;
    ...
    private int minValue(final MapS map, final int x, final int y, final int xe, final int ye, final int depth, final int alpha, int beta) {
        ...
        final int t = 305 * this.luonggiaOutside(new MapS(map), x, y, xe, ye) + 121 * this.luonggiacanh(new MapS(map), x, y, xe, ye, false);
        if (t > 1 || t < -1) {
            return t * 5;
        }
        return t;
